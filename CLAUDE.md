...
- Explicit return types on public functions and exported APIs (exception: factory functions where the return type is derived via `ReturnType<typeof fn>`, e.g. `createApp`, `createDb`)
